...
from pyspark.sql.functions import (udf,year,month,dayofmonth,hour,weekofyear,dayofweek,monotonically_increasing_id)
...
def process_log_data(spark, input_data, output_data):
    ...
    time_table.write.partitionBy("year", "month").parquet(f"{output_data}/times", mode="overwrite")
